        ...
        <section class="inner-banner">
            ...
            <div class="auto-container">
                <div class="inner">
                    <h1>Contact Us</h1>
                    <div class="sub_text">
                        <p> Connect with The Diwaan Restaurant - <span class="primary-color"> where royal flavors await
                                your arrival.</span></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="loc-block info-block col-lg-5 col-md-12 col-sm-12">
                            <div class="visit-us-card">
                                <div class="contact-image">
                                    <img src="images/contact/contact-1.webp" alt="The Diwaan Restaurant">
                                </div>
                                <div class="card-content">
                                    ...
                                    <div class="text">
                                        ...
                                        <span class="more-link"> Reservations : <a
                                                href="tel:+91-7838886804">+91-7838886804</a> </span> <br>
                                        <span class="more-link"> Email: <a
                                                href="mailto:thediwaan9@gmail.com">thediwaan9@gmail.com</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="loc-block col-lg-6 col-md-12 col-sm-12">
                            <div class="form-side">
                                <div class="title-box centered">
                                    ...
                                    <h2>Message Us</h2>
                                    <div class="text desc">Planning a special celebration or have dietary preferences?
                                        Our team is delighted to assist with your royal dining experience!</div>
                                </div>
