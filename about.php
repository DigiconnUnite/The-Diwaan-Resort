  ...
  <div class="page-wrapper"> 
    ...
    <section class="inner-banner">
        ...
        <div class="auto-container">
            <div class="inner">
                <h1>About Us</h1>
                <div class="sub_text"> <p> Experience centuries of royal flavors reimagined with <span class="primary-color"> contemporary elegance in Agra.</span></p> </div>
            </div>
        </div>
    </section>
    <!--End Banner Section -->
            ...
            <div class="row clearfix">
                ...
                <div class="text-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="text"> Nestled in the heart of Agra, Diwaan brings together the rich culinary traditions of North and South India with the royal legacy of Mughlai cuisine. Our chefs craft each dish using time-honored recipes passed through generations, creating an unforgettable dining experience.</div>
                        ...
                        <div class="feature-info">
                            ...
                            <div class="feature-info-box">
                                ...
                                <div class="infotext"> Our kitchen follows the highest standards of cleanliness, ensuring every dish is prepared with utmost care.</div>
                            </div>
                            ...
                            <div class="feature-info-box">
                                ...
                                <div class="infotext"> Step into an atmosphere that blends traditional Indian aesthetics with contemporary comfort.</div>
                            </div>
                ...
                <div class="image-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="images parallax-scene-1">
                            <div class="image" data-depth="0.15"><img src="images/about/about-1.png" alt="image"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="s-block alternate">
                            <div class="inner">
                                ...
                                <div class="text">From intimate family gatherings to grand celebrations, our team crafts memorable experiences with authentic flavors.</div>
                            </div>
                        </div>
                        <div class="s-block alternate">
                            <div class="inner">
                                ...
                                <div class="text">Experience the perfect blend of traditional Indian cuisine with contemporary elegance in our exclusive dining spaces.</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="s-block ">
                            <div class="inner">
                                ...
                                <div class="text">Our elegant banquet hall features traditional Indian decor with modern amenities, perfect for weddings and special events.</div>
                            </div>
                        </div>
                        <div class="s-block ">
                            <div class="inner">
                                ...
                                <div class="text">Bring the royal flavors of Diwaan to your venue with our bespoke catering services for all occasions and celebrations.</div>
                            </div>
                        </div>
                    </div>
                </div>
