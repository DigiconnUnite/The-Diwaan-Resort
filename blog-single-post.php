...
<head>
  <meta charset="utf-8">
  <title>The Diwaan Restaurant - Blog Post</title>
  <!-- Stylesheets -->
      ...
      <div class="auto-container">
        <div class="blog_inner_pannel">
          <div class="blog_info info" data-aos="fade-up" data-aos-duration="2000">
            ...
            <p>Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been the industrys
              standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make
              a type specimen booksince the when an unknown printer took a galley of type and scrambled it to make a
              type specimen book. It has survived not only five centuries, but also the leap into electronic
              typesetting.</p>

          </div>
          <div class="main_img">
            <img src="images/resource/blog-single.webp" alt="image">
          </div>
          <div class="info" data-aos="fade-up" data-aos-duration="1500">
            ...
            <p>Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been the industrys
              ...
              a type specimen booksince the when an unknown printer took a galley of type and scrambled it to make a
              type specimen book. It has survived not only five centuries, but also the leap into electronic
              typesetting. Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been
              the industrys standard dummy text ever since the when an unknown printer took a galley of type and
              scrambled it to make a type specimen booksince the when an unknown printer took a galley of type and
          ...
          <div class="info" data-aos="fade-up" data-aos-duration="1500">
            ...
            <p>Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been the industrys
              ...
              Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been the industrys
              standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make
              a type specimen booksince the when an unknown printer took a galley of type and scrambled it to make a
              type specimen book. It has survived not only five centuries, but also the leap into electronic
              typesetting. Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been
              the industrys standard dummy text ever since the when an unknown printer took a galley of a type specimen
              booksince the when an unknown printer.
            </p>
          </div>
          ...
          <div class="info" data-aos="fade-up" data-aos-duration="1500">
            ...
            <ul>
              <li data-aos="fade-up" data-aos-duration="1500">
                <p> <span class="icon"><i class="fa-regular fa-circle-check"></i></span> When an unknown printer took a
                  galley of type </p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <p> <span class="icon"><i class="fa-regular fa-circle-check"></i></span> Scrambled it to make a type
                  specimen</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
              ...
              <li data-aos="fade-up" data-aos-duration="1500">
                <p> <span class="icon"><i class="fa-regular fa-circle-check"></i></span> Make a type specimen book it
                  has survived. </p>
              </li>
            </ul>
          </div>
            ...
            <ul>
              <li data-aos="fade-up" data-aos-duration="1500">
                <div class="authore_info">
                  <div class="avtar">
                    <img src="images/resource/comment1.webp" alt="image">
                  </div>
                  <div class="text">
                ...
                <div class="comment">
                  <p>Dummy text of the printing and types etting industry lorem Ipsum has been the indu has been the
                    industrys standardbeen the industrys standard dummy text ever since.</p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500" class="replay_comment">
                <div class="authore_info">
                  <div class="avtar">
                    <img src="images/resource/comment2.webp" alt="image">
                  </div>
                  <div class="text">
                ...
                <div class="comment">
                  <p>Industry lorem Ipsum has been the indu has been the industrys standard dummy unknown printer took a
              ...
              <li data-aos="fade-up" data-aos-duration="1500">
                <div class="authore_info">
                  <div class="avtar">
                    <img src="images/resource/comment3.webp" alt="image">
                  </div>
                  <div class="text">
                    <span>2 days ago</span> <br>
                    Wilson Joy
                ...
                <div class="comment">
                  <p>Took a galley of type and scrambled it to make a type specimen booksince the when an unknown
                    printer took a galley of type and scrambled it to make a type specimen book Standard dummy text ever
