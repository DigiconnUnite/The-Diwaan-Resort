    ...
    <section class="special-offer-two section-kt">
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="offer-block-three col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="image"><a href="#"><img src="images/resource/dish1-special.png" alt="image"></a></div>
            ...
            <div class="row clearfix">
                <div class="offer-block-three col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="text desc">Dal Fry, Matar Paneer, Mix Veg, Rice, Raita, Salad, Papad, Gulab Jamun, 4 Butter Roti.</div>
                ...
                <div class="offer-block-three col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        ...
                        <div class="text desc">Malai Kofta, Dalmakhani, Paneer Butter Masala, Mix Veg, Jeera Rice, Salad, Papad, 1 Butter Naan, 1 Stuffed Naan, 1 Laccha Paratha, Raita, 1 Gulab Juman.</div>
